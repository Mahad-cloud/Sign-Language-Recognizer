...
model = tf.keras.Sequential([VGG, tf.keras.layers.Flatten(), tf.keras.layers.Dense(units=256, activation="relu"),
...
train_dir = '/media/mahad/BE3233F53233B0EF/fyp/mobile_word_based_videos/dataset_word/diverse_dataset/train/traini/'
...
# model.save('VGG_words.h5')

model.save('model_ResNet50_9_classes_diverse.h5')
